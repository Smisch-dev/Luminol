# Local Development
Luminol is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Luminol will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Luminol assets building. After that, its as
...
the asset URLs used in Luminol.
