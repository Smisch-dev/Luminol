...
return [
    ...
    */
    ...
    | standard Luminol shipped services.
    */
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('LUMINOL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('LUMINOL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('LUMINOL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('LUMINOL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('LUMINOL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('LUMINOL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('LUMINOL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('LUMINOL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('LUMINOL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('LUMINOL_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by Luminol.
    */

    'telemetry' => [
        'enabled' => env('LUMINOL_TELEMETRY_ENABLED', true),
    ],
];
