...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Luminol.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="luminol:guzzle:connect_timeout" value="{{ old('luminol:guzzle:connect_timeout', config('luminol.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="luminol:guzzle:timeout" value="{{ old('luminol:guzzle:timeout', config('luminol.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="luminol:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('luminol:client_features:allocations:enabled', config('luminol.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="luminol:client_features:allocations:range_start" value="{{ old('luminol:client_features:allocations:range_start', config('luminol.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="luminol:client_features:allocations:range_end" value="{{ old('luminol:client_features:allocations:range_end', config('luminol.client_features.allocations.range_end')) }}">
