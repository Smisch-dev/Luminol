...
use Luminol\Exceptions\Repository\DuplicateDatabaseNameException;
use Luminol\Exceptions\Service\Database\TooManyDatabasesException;
use Luminol\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \Luminol\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('luminol.client_features.databases.enabled')) {
     ...
     *
     * @throws \Luminol\Exceptions\Repository\DuplicateDatabaseNameException
     * @throws \Throwable
     */
