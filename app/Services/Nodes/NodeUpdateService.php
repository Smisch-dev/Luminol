...
use Luminol\Exceptions\Service\Node\ConfigurationNotPersistedException;
...
class NodeUpdateService
{
    ...
    public function handle(Node $node, array $data, bool $resetToken = false): Node
    {
        ...
        [$updated, $exception] = $this->connection->transaction(function () use ($data, $node) {
            /** @var \Luminol\Models\Node $updated */
            ...
            try {
                ...
                //
                // @see https://github.com/luminol/panel/issues/1931
                ...
                //
                // @see https://github.com/luminol/panel/issues/2712
                return [$updated, true];
            }
