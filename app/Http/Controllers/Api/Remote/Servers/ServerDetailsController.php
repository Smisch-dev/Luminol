...
use Luminol\Services\Eggs\EggConfigurationService;
use Luminol\Repositories\Eloquent\ServerRepository;
use Luminol\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \Luminol\Models\ActivityLog|null $activity */
