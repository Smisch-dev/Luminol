...
use Luminol\Transformers\Api\Client\ScheduleTransformer;
use Luminol\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \Luminol\Models\Schedule $model */
