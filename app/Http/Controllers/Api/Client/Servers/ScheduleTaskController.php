...
use Luminol\Transformers\Api\Client\TaskTransformer;
use Luminol\Http\Requests\Api\Client\ClientApiRequest;
use Luminol\Http\Controllers\Api\Client\ClientApiController;
use Luminol\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Luminol\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
     ...
     * @throws \Luminol\Exceptions\Service\ServiceLimitExceededException
     */
    public function store(StoreTaskRequest $request, Server $server, Schedule $schedule): array
    {
        $limit = config('luminol.client_features.schedules.per_schedule_task_limit', 10);
        ...
        /** @var \Luminol\Models\Task|null $lastTask */
        $lastTask = $schedule->tasks()->orderByDesc('sequence_id')->first();

        /** @var \Luminol\Models\Task $task */
