...
use Luminol\Services\Subusers\SubuserCreationService;
use Luminol\Repositories\Wings\DaemonServerRepository;
use Luminol\Transformers\Api\Client\SubuserTransformer;
...
use Luminol\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Luminol\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Luminol\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Luminol\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
    ...
    {
        /** @var \Luminol\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
