...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'luminol:guzzle:timeout',
        'luminol:guzzle:connect_timeout',
        'luminol:console:count',
        'luminol:console:frequency',
        'luminol:auth:2fa_required',
        'luminol:client_features:allocations:enabled',
