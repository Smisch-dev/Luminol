...
namespace Luminol\Extensions\Spatie\Fractalistic;
...
use Luminol\Extensions\League\Fractal\Serializers\LuminolSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new LuminolSerializer();
        }
